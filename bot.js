...
client.user.setGame(`Gaming World BroadCast`,"http://twitch.tv/Gaming World")
...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "invite")) {
        let invite = new Discord.RichEmbed()
            ...
            .setURL(`https://discordapp.com/api/oauth2/authorize?client_id=620984346064715828&permissions=8&scope=bot`);
...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "help")) {
        let help = new Discord.RichEmbed()
            ...
            رابط سيرفر الدعم الفني : https://discord.gg/cfCyW56
            **`);
            message.channel.sendEmbed(help); // رابط السيرفر يعود الى سيرفر Gaming World .
    }
});
